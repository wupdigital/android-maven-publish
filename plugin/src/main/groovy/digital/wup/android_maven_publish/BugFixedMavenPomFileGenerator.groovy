...
class BugFixedMavenPomFileGenerator extends MavenPomFileGenerator {
    BugFixedMavenPomFileGenerator(MavenProjectIdentity identity, VersionRangeMapper versionRangeMapper) {
        super(identity, versionRangeMapper)
    }
